...
public class main {
    public static void main(String[] args) {
        ...
        System.out.println("Base Salary: Rwf" + payslip.getBaseSalary() + " | RSSB Registered: " + payslip.isRssbRegistered());
        System.out.println("Pay Period: " + payslip.getMonth() + "/" + payslip.getYear());
        System.out.println("Basic Pay: Rwf" + payslip.getBasicPay());
        System.out.println("Allowances - Transport: Rwf" + payslip.getTransportAllowance() + " | Housing: $" + payslip.getHousingAllowance());
        System.out.println("Overtime: " + payslip.getOvertimeHours() + " hours @ Rwf" + payslip.getOvertimeRate());
        System.out.println("Bonus: $" + payslip.getBonus());
        System.out.println("Deductions - Loan: Rwf" + payslip.getLoanDeduction());
        System.out.println("Gross Salary: Rwf" + payslip.getGrossSalary() + " | Total Deductions: Rwf" + payslip.getTotalDeductions() + " | Net Salary: Rwf" + payslip.getNetSalary());
